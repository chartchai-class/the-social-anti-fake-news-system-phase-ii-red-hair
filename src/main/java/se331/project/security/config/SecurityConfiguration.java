package se331.project.security.config;
...
public class SecurityConfiguration {
  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    ...
    http
            ...
            .authorizeHttpRequests((authorize) -> {
                authorize.requestMatchers("/api/v1/auth/**").permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET,"/users/profiles/{id}").hasRole("ADMIN")
                        ...
                        .requestMatchers(HttpMethod.GET,"/news/{id}/comments").permitAll()
                        .requestMatchers(HttpMethod.GET, "/admin/news/{id}/comments").hasRole("ADMIN")
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOriginPatterns(List.of("http://localhost:5173", "http://13.212.6.216:8001", "http://54.167.67.248:8001")); //NEED to add frontend VM url here
